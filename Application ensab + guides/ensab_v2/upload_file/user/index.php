...
$title = 'Mon Compte';
 ...
 $etape = $row['etape'];
 $image= $row['image']; // correction probleme d'affichage d'image
...
<div class="col-md-6">
<img src="../uploads/<?php if (empty($image)) {echo 'no_image.png';} else {echo "../".$image;}  ?>" class="img-thumbnail"  width="150px">
</div>
<div class="col-md-6">
